    ...
    <section class="space-y-6">
        <div class="rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-700 dark:bg-zinc-900">
            <div class="flex items-center justify-between">
                ...
                <a
                    href="{{ asset('mapa-lotificacion.pdf') }}"
                    download="mapa-lotificacion-nueva-jerusalem.pdf"
        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-700 dark:bg-zinc-900">
            <div class="relative overflow-hidden rounded-lg" style="height: 90vh;">
                <object
                    data="{{ asset('mapa-lotificacion.pdf') }}"
                ...
                >
                    ...
                    <p class="text-center text-neutral-600 dark:text-neutral-300">
                        Tu navegador no soporta embeds de PDF. <a href="{{ asset('mapa-lotificacion.pdf') }}" class="font-semibold text-blue-600 hover:underline dark:text-blue-400">Descargar PDF aquí</a>.
                    </p>
                </object>
            </div>
        </div>

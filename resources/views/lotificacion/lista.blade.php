                    ...
                    <div>
                        ...
                        <div class="mt-4 grid gap-3 sm:grid-cols-2">
                            <div class="rounded-lg border border-zinc-200 p-3 dark:border-zinc-700">
                                ...
                                <div class="text-sm font-semibold text-zinc-900 dark:text-white" x-text="selected().estado_label"></div>
                            </div>

                            <div class="rounded-lg border border-zinc-200 p-3 dark:border-zinc-700">
                                <div class="text-xs text-zinc-500 dark:text-zinc-400">Fecha de cambio</div>
                                <div class="text-sm font-semibold text-zinc-900 dark:text-white" x-text="selected().fecha_cambio"></div>
                            </div>
                            ...
                            <div class="rounded-lg border border-zinc-200 p-3 dark:border-zinc-700 sm:col-span-2">
                                ...
                                <div class="text-sm font-semibold text-zinc-900 dark:text-white" x-text="selected().adquiriente"></div>
                            </div>

                            <div class="rounded-lg border border-zinc-200 p-3 dark:border-zinc-700 sm:col-span-2">
                                <div class="text-xs text-zinc-500 dark:text-zinc-400">Observaciones</div>
                                <div class="text-sm text-zinc-900 dark:text-white" x-text="selected().observaciones"></div>
                            </div>
                        </div>
                    </div>
                </template>
